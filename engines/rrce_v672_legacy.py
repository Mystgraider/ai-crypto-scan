"""Exact V6.7.2 RRCE replay engine preserved for strategy-comparison diagnostics.

Source contract: engines/rrce_engine.py at commit
8dbb4fc23890a51dc9661c4cb2fcd5f38a7a7e8a.
This module is diagnostic-only and must not be used for production signal gating.
"""
